...
function drawCollapsibleTree(containerSvgId, treeSvgId) {
    ...
    margin = {top: 100, bottom: 0, left: 100, right: 100};
    ...
    g = treeSvg.append("g").attr("transform", "translate(" + margin.top + "," + margin.left + ")");
